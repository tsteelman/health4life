...
<div class="page-content">
    <section class="grid_12">
	    ...
	    <?php echo $this->Form->create('NewsletterTemplate', array('class' => 'block-content form', 'id' => 'AddNewsletterTemplateForm', 'inputDefaults' => array('div' => false, 'label' => false))); ?>
            <h1><?php echo __('Add Newsletter Template'); ?></h1>
            <table class="table sortable no-margin" cellspacing="0" width="100%" style="margin-left: 0.33em; margin-bottom:-0.67em; ">
			    ...
			    <?php echo $this->Form->input('template_body', array('id' => 'template_body', 'class' => 'form-control ckeditor', 'style' => 'width: 450px;')); ?>
                        </div>
                    </td>
                </tr>
            </table>
			...
			<?php
			echo $this->Form->submit(__('Save', true), array('div' => false, 'onclick' => 'check_form()', 'class' => 'btn btn-small btn-success', 'style' => 'float: right; margin-right: 45px; min-width: 90px; height: 35px !important;'));
