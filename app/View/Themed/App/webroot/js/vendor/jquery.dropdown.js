/// <reference path="../intellisense/jquery-1.2.6-vsdoc-cn.js" />
        (function($) {
            ...
            function applySlimScrollToTimePicker(className, height) {
                $('.'+className+' ul').slimScroll({
                    color: '#BBDAEC',
                    railColor: '#EBF5F7',
                    size: '5px',
                    height: height+'px',
            ...
            $.fn.dropdown = function(o) {
                ...
                me.click(function() {
                    ...
                    /*Applying slimscroll functionality to drop down list*/
                    applySlimScrollToTimePicker(options.containerCssClass, options.dropheight);
                    /*Applying slimscroll functionality to drop down list*/
                    return false;
                });
