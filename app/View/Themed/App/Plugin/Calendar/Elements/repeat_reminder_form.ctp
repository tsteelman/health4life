...
//            }
            ?>
        <?php echo $this->Form->input('repeat_mode', array('label' => false, 'id'=>'EventRepeatMode', 'options' => $repeatModes, 'selected' => $defaultRepeatMode, 'class' => 'form-control')); ?>
    </div>
</div>
<div class="form-group" id="repeat_interval_fields">
    ...
    <div class="col-lg-4 col-sm-4 col-md-5">
        <?php echo $this->Form->input('repeat_interval', array('label' => false, 'id'=>'EventRepeatInterval', 'class' => 'pull-left form-control width70', 'options' => $repeatIntervalList, 'selected' => $repeatIntervalOpt)); ?>
...
<div class="form-group">
    ...
    <div class="col-lg-8 col-sm-8 col-md-8">
        <input type="radio" id="never_end_chk" class="repeat_end_type_chk" name="data[CalendarForm][repeat_end_type]" checked = 'checked' value="<?php echo Event::REPEAT_END_NEVER; ?>" />
...
<div class="form-group">
    ...
    <div class="col-lg-9 col-sm-9 col-md-9">
        ...
        <input type="radio" id="end_on_chk" class="repeat_end_type_chk flt_lft" name="data[CalendarForm][repeat_end_type]"  <?php echo (isset($eventData['repeat_end_type']) && $eventData['repeat_end_type'] == Event::REPEAT_END_DATE) ? " checked = 'checked'" : ''; ?> value="<?php echo Event::REPEAT_END_DATE; ?>"/>
        <span class="flt_lft padding-2"><?php echo __('On'); ?> </span>
        <?php echo $this->Form->input('end_date', array('id'=> 'EventEndDate', 'readonly'=> 'readonly', 'label' => false , 'type' => 'text', 'disabled' => $isDisabled, 'class' => 'flt_lft form-control event_ends_on_date')); ?>
