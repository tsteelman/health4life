<div class="wizard hide" id="registrationWizard_<?php echo $type ?>">
    <ul class="steps">
		<li data-target="#step_<?php echo $type ?>_1" data-title="Friend SignUp" class="active"></li>
    ...
    <div class="step-content signup_fields">
        <div class="step-pane active" id="step_<?php echo $type ?>_1">
            <?php echo $this->element('User.basic_form'); ?>
        </div>
        <div class="step-pane" id="step_<?php echo $type ?>_2">
            <?php echo $this->element('User.profile_form', array(
				'profilePhotoClass' => 'border_other',
				'defaultProfilePhoto' => 'user_default_4_medium.png',
				'type' => $type
				)); ?>
