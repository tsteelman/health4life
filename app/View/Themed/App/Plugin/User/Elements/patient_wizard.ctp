<div class="wizard hide" id="registrationWizard_<?php echo $type ?>">
    <ul class="steps">
        <li data-target="#step_<?php echo $type ?>_1" data-title="Patient SignUp" class="active"></li>
        <li data-target="#step_<?php echo $type ?>_2" data-title="Complete your profile" ></li>
        <li data-target="#step_<?php echo $type ?>_3" data-title="Share Diagnosis Details" ></li>
    </ul>
    <div class="step-content signup_fields">
        ...
        <div class="step-pane" id="step_<?php echo $type ?>_2">
            ...
            echo $this->element('User.profile_form', array(
				'profilePhotoClass' => 'border_patient',
				'defaultProfilePhoto' => 'user_default_1_medium.png',
				'type' => $type
				));
            ?>
