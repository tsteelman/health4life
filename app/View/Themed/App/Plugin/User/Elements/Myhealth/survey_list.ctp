<!-- Modal -->
<div class="modal fade" id="surveyList" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">You have following questionaire(s) to be completed regarding your disease related information:</h4>
            </div>
            <div class="modal-body">
                <div class="disease_info_popup">    
                    <?php foreach($diseaseSurvey as $survey) { ?> 
                            <div class="clearfix">
