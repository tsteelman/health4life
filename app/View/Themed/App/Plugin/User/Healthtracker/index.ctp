...
$this->Html->addCrumb('Current Health');
?>
<div class="container">
	...
	<div class="graph_container">
        <div>
            <div class="row"> 
                ...
                if ($is_same) {
                    ?>
                    <div class="col-lg-6"><h2>My Weight</h2></div>
                    <?php
                } else {
                    ?>
                    <div class="col-lg-6"><h2><?php echo __($profile_owner . "'s "); ?>Weight</h2></div>
                    <?php
                }
                ?>
                <div class="col-lg-6">
                    <?php if ($isOwner): ?>
                        <button data-toggle="modal" data-target="#readWeight" data-backdrop="static" data-keyboard="false"  class="pull-right btn create_button " >Add weight now</button>
                        <a href="/user/manage_health?record_type=1"><button type="button" class="pull-right btn btn_add ">Manage Weight history</button></a>
                    <?php endif; ?>
                </div>      
            </div>
    ...
    <div class="graph_container">
        <div>
            <div class="row"> 
                ...
                if ($is_same) {
                    ?>
                    <div class="col-lg-6"><h2>Blood Pressure</h2></div>
                    <?php
                } else {
                    ?>
                    <div class="col-lg-6"><h2><?php echo __($profile_owner . "'s "); ?>Blood Pressure</h2></div>
                    <?php
                }
                ?>
                <div class="col-lg-6">
                    <?php if ($isOwner): ?>
                        <button data-toggle="modal" data-target="#readBp" data-backdrop="static" data-keyboard="false"  class="pull-right btn create_button " >Add BP now</button>
                        <a href="/user/manage_health?record_type=3"><button type="button" class="pull-right btn btn_add " >Manage BP history</button></a>
                    <?php endif; ?>
                </div>      
            </div>
    ...
    <div class="graph_container">
        <div>
            <div class="row"> 
                ...
                if ($is_same) {
                    ?>
                    <div class="col-lg-6"><h2>My Temperature</h2></div>
                    <?php
                } else {
                    ?>
                    <div class="col-lg-6"><h2><?php echo __($profile_owner . "'s "); ?>Temperature</h2></div>
                    <?php
                }
                ?>
                <div class="col-lg-6">
                    <?php if ($isOwner): ?>
                        <button data-toggle="modal" data-target="#readTemperature" data-backdrop="static" data-keyboard="false"  class="pull-right btn create_button " >Add Temperature now</button>
                        <a href="/user/manage_health?record_type=4"><button type="button" class="pull-right btn btn_add " >Manage temperature history</button></a>
                    <?php endif; ?>
                </div>      
            </div>
    ...
    <div class="graph_container">
        <div>
            <div class="row"> 
                ...
                if ($is_same) {
                    ?>
                    <div class="col-lg-6"><h2>My BMI</h2></div>
                    <?php
                } else {
                    ?>
                    <div class="col-lg-6"><h2><?php echo __($profile_owner . "'s "); ?>BMI</h2></div>
                    <?php
                }
                ?>
                <!--                <div class="col-lg-6">
...
<?php $printData = array('My Weight', 'Blood Pressure', 'My Temperature', 'My BMI'); ?>
...
<script type="text/javascript">
    ...
    function load_stock_graph(graph_type) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i in data.bmi)
                    bmi_result.push([(i * 1000), data.bmi[i] * 1]);
                ...
                plot_stock_graph('#status_graph_container', bmi_result, 'Bmi');
    ...
    function plot_stock_graph(container, readings, series_name, options) {
        ...
        if(app.show_site_notfications) {
            showSiteNotification('Updated Health Tracker graphs', 'info');
        }
    }
