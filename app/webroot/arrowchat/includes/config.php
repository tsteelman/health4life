<?php 
	...
	*/	
    ...
    require_once $root . $ds . 'app'. $ds .'webroot'. $ds .'arrowchat'. $ds .'cake_bootstrap.php';
	...
	*/
	define('DB_SERVER',$dataSource->config['host']); 
	define('DB_USERNAME',$dataSource->config['login']); 
	define('DB_PASSWORD',$dataSource->config['password']); 
	define('DB_NAME',$dataSource->config['database']);	
	...
	*/
	...
	define('DB_USERTABLE_AVATAR','profile_picture');
        define('DB_USERTABLE_FIRST_NAME','first_name');  
	define('DB_USERTABLE_LAST_NAME','last_name'); 
