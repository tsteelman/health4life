 ...
 * UploadHandler class.
 *
 * UploaderComponent is used for uploading files to the system
 * 
 *
 * @author 		Ajay Arjunan
 * @package 	app.Plugin.Uploader
 * @category	component
 */
class UploaderComponent extends Component {

    public $allowedExtensions = array();
    public $minImageSize = array();
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        // check minimum file dimension for images
        if(in_array(strtolower($ext), $this->allowedExtensions))
        {
        	$image_info = getimagesize($file['tmp_name']);
        	if(!empty($this->minImageSize))
        	{
        		if($image_info['0'] < $this->minImageSize['0'] ||
        		$image_info['1'] < $this->minImageSize['1'])
        		{
        			return array('error' => 'Image dimension should be a minimum of '.$this->minImageSize['0'] .' x '.$this->minImageSize['1']);
        		}
        	}
        }
